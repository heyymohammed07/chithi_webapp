...
export function NotFoundScreen({
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6 text-center">
      <div className="max-w-md w-full p-8 border border-ink-hairline rounded-card bg-ink-raised shadow-modal space-y-5">
        {/* Torn-paper motif hairline (§16) */}
        <div className="w-12 h-1 bg-gold mx-auto rounded-full" />

        <h2 className="text-2xl font-serif font-bold text-ivory">
